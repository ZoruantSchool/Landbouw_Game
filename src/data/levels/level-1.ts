...
const levelEen = {
  ...
  optimalePlaatsing: [
    ...
    { plantId: 'bosaardbei', rij: 2, kolom: 7, breedte: 1, hoogte: 1 },
    { plantId: 'bosaardbei', rij: 4, kolom: 6, breedte: 1, hoogte: 1 },
    { plantId: 'bosaardbei', rij: 5, kolom: 6, breedte: 1, hoogte: 1 },
    { plantId: 'bosaardbei', rij: 6, kolom: 6, breedte: 1, hoogte: 1 },
  ],
  combos: [
