...
import notenpestoBeeld from '../../../assets/gerecht-notenpesto.png'
import appeltaartBeeld from '../../../assets/gerecht-appeltaart.png'
import kruidensoepBeeld from '../../../assets/gerecht-kruidensoep.png'
import walnootHazelnootpastaBeeld from '../../../assets/level-3-walnoot-hazelnootpasta.png'
...
const receptKaarten = [
  { naam: 'Wilde bessenjam', omschrijving: 'met appel en kruiden', vereistLevel: 1, afbeelding: bessenjamBeeld },
  { naam: 'Kruidensalade', omschrijving: 'uit het voedselbos', vereistLevel: 1, afbeelding: kruidensaladeBeeld },
  { naam: 'Notenpesto', omschrijving: 'met wilde kruiden', vereistLevel: 2, afbeelding: notenpestoBeeld },
  { naam: 'Appeltaart', omschrijving: 'met notenmeel', vereistLevel: 2, afbeelding: appeltaartBeeld },
  { naam: 'Kruidensoep', omschrijving: 'met kruiden uit het voedselbos', vereistLevel: 3, afbeelding: kruidensoepBeeld },
  { naam: 'Walnoot-hazelnootpasta', omschrijving: 'met wilde kruiden en bessencompote', vereistLevel: 3, afbeelding: walnootHazelnootpastaBeeld },
]
...
.gerechten-tabs button { min-width: 145px; height: 46px; border: 0; border-bottom: 3px solid transparent; background: transparent; color: #638166; font-size: 14px; font-weight: 700; }
...
.statistieken article { display: grid; height: 88px; place-content: center; border: 1px solid #3b7042; border-radius: 9px; background: #0c2912; text-align: center; }
...
.recepten { display: grid; width: 100%; grid-template-columns: repeat(6, minmax(155px, 1fr)); gap: 14px; }
.recept-kaart { min-width: 0; overflow: hidden; border: 2px solid #d5a600; border-radius: 11px; background: #071f0d; box-shadow: 0 5px 13px rgba(0, 0, 0, .25); }
...
.recept-beeld img { display: block; width: 100%; height: 100%; min-width: 0; min-height: 0; object-fit: contain; object-position: center center; }
...
.achievements article { display: grid; min-height: 72px; grid-template-columns: 48px 1fr auto; align-items: center; gap: 14px; border: 1px solid #35683c; border-radius: 8px; background: #0c2912; padding: 10px 15px; }
...
@media (max-width: 1100px) { .recepten { grid-template-columns: repeat(3, minmax(0, 1fr)); } }
