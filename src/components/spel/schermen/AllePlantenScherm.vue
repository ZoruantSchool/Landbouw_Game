...
.planten-tabs button { min-width: 145px; height: 46px; border: 0; border-bottom: 3px solid transparent; background: transparent; color: #66856a; padding: 0 17px; font-size: 14px; font-weight: 700; transition: color 0.15s ease, border-color 0.15s ease; }.planten-tabs button:hover { color: #91d57d; }.planten-tabs .actief { border-bottom-color: #65bc4d; color: #91d57d; }
...
.plant-tegel { display: grid; min-width: 0; height: 210px; grid-template-rows: 112px auto auto; overflow: hidden; border: 1px solid #2d6032; border-radius: 10px; background: #102d16; color: #dce9cf; padding: 0; text-align: left; transition: transform 0.2s ease, box-shadow 0.2s ease, border-color 0.2s ease; }
.plant-tegel:hover { transform: translateY(-4px); border-color: #4c933c; box-shadow: 0 12px 24px rgba(0, 0, 0, 0.32); }
.plant-tegel.geselecteerd { border: 3px solid #dda915; background: #283b16; }.plant-beeld { display: grid; width: 100%; height: 112px; place-items: center; background: #153f1b; }.plant-beeld img { width: 88px; height: 88px; object-fit: contain; transition: transform 0.2s ease; }.plant-tegel:hover .plant-beeld img { transform: scale(1.12); }.plant-tegel strong { padding: 12px 16px 3px; color: #f2ebd1; font-size: 15px; }.plant-tegel small { align-self: center; width: fit-content; margin: 4px 16px 12px; border: 1px solid #4b8f45; border-radius: 4px; color: #8bc77b; padding: 5px 9px; font-size: 11px; }
...
.plant-detail h2 { margin-top: 14px; color: #eee2bd; font-family: Georgia, 'Times New Roman', serif; font-size: 36px; }.intro-tekst, .eigenschappen p { margin-top: 13px; color: #c0d0bf; font-size: 14px; line-height: 1.6; }.eigenschappen { margin-top: 26px; padding-top: 18px; border-top: 1px solid #3b6940; }.eigenschappen p { margin-top: 10px; }.combinaties { margin-top: 26px; }.combinaties h3 { margin-bottom: 12px; }.combinaties article { display: flex; align-items: center; gap: 15px; margin-top: 10px; border: 1px solid #36713d; border-radius: 8px; background: #0c2a12; padding: 11px 14px; transition: transform 0.2s ease, box-shadow 0.2s ease, border-color 0.2s ease; }.combinaties article:hover { transform: translateX(4px); border-color: #4c933c; box-shadow: 0 8px 16px rgba(0, 0, 0, 0.28); }.combinaties article img { width: 46px; height: 46px; object-fit: contain; }.combinaties article div { display: grid; gap: 3px; }.combinaties article strong { color: #e5efd9; font-size: 14px; }.combinaties article span { color: #91aa93; font-size: 12px; line-height: 1.4; }
